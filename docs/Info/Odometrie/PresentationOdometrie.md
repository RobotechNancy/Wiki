...
![Robot sur le plateau de jeu](/images/aruco/robotplateau.webp){:loading="lazy"}
...
![Schéma localisation robot par caméras](/images/aruco/odometrieabsoluecam.webp){:loading="lazy"}
